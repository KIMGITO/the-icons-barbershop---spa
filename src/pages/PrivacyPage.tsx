...
const PRIVACY_SECTIONS: PrivacySection[] = [
  ...
  },
  {
   ...
   {
    title: '8. Booking, Cancellation & No-Show Policy',
    icon: <CalendarCheck className="w-3.5 h-3.5" />,
    paragraphs: [
      'All bookings require a 50% deposit to confirm the appointment. Once a booking has been confirmed and payment has been made, the deposit is non-refundable. Please make sure you have selected the correct service, date, time, and service provider before completing your booking.',
      'If you do not show up on the same day and at the time of your appointment, your 50% deposit will be forfeited. No refund or credit will be issued for missed appointments.',
      'If you need to change your appointment time, please contact The Icons Barber & Spa as early as possible. Time changes are subject to availability and must be arranged directly with the shop. Do not assume that a new time is confirmed until the shop has approved the change.',
      'Appointments must be booked at least 1 hour before the requested appointment time. Online bookings are not available within the final 30 minutes before the shop closes. This allows our team enough time to prepare for and properly serve each client.',
      'By completing a booking and paying the required deposit, you acknowledge and agree to these booking, cancellation, rescheduling, and no-show terms.',
    ],
  },
  {
...
export const PrivacyPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-white pt-24 pb-20">
      ...
      <section
        className="max-w-4xl mx-auto px-4 sm:px-6 pt-4 pb-8 text-center"
        aria-label="Privacy Policy Header"
      >
        <nav
          aria-label="Breadcrumb"
          className="inline-flex items-center gap-2 text-[11px] text-muted-foreground mb-4 w-full "
        >
          <button
            onClick={() => navigateTo('/')}
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 space-y-4">
          ...
          <div className="flex items-start gap-3">
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground-light leading-relaxed font-light">
                Your contact and appointment records are encrypted and strictly
                used for confirmation notices, bespoke loyalty offerings, and
                booking reminders. We are committed to protecting your personal
        ...
        {/* Contact Callout */}
        <section
          className="p-6 sm:p-8 bg-card border border-border rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left"
        ...
        >
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground font-light">
              Contact our data protection contact in Nairobi — we respond
              promptly.
            </p>
